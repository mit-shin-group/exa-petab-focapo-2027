...
#                                            (changes Optim g_tol, Fides gatol, 1e-6 is their defaults)
...
const BENCH_WARMUP_MODEL  = "Bruno_JExpBot2016"  # shared JIT-warmup model (benchmarked alone via run_warmup.jl)
